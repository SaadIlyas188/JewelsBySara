      ...
      <section className="relative bg-white py-16 sm:py-20 lg:py-32">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center space-y-6 sm:space-y-8">
            <Badge className="bg-gold/20 text-foreground border-gold/30 text-sm sm:text-base">About Us</Badge>
            ...
            <p className="text-base sm:text-lg md:text-xl text-muted-foreground leading-relaxed font-light max-w-3xl mx-auto">
              JewelsBySara is more than a brand—it's a celebration of love, tradition, and artistry that makes your
        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-10 lg:gap-16 lg:grid-cols-2 items-center">
            ...
            <div className="space-y-5 sm:space-y-6">
              <h2 className="font-serif text-3xl sm:text-4xl font-bold text-balance">Our Story</h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed text-base sm:text-lg font-light">
                ...
                <p>
                  Our founder, Sara, envisioned a brand that honors wedding ceremonies through meticulously crafted
                  pieces — each one a keepsake that carries the memories of your most cherished day.
                </p>
                <p>
      ...
      <section className="py-16 sm:py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12 sm:mb-16">
            <h2 className="font-serif text-3xl sm:text-4xl font-bold mb-4 sm:mb-6">Our Values</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-6 sm:p-8 text-center space-y-4">
                ...
                <h3 className="font-serif text-lg sm:text-xl font-semibold">Crafted with Love</h3>
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-6 sm:p-8 text-center space-y-4">
                ...
                <h3 className="font-serif text-lg sm:text-xl font-semibold">Artisan Partnership</h3>
                <p className="text-muted-foreground font-light text-sm sm:text-base">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all">
              <CardContent className="p-6 sm:p-8 text-center space-y-4">
                ...
                <h3 className="font-serif text-lg sm:text-xl font-semibold">Premium Quality</h3>
                <p className="text-muted-foreground font-light text-sm sm:text-base">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-all lg:col-span-3 sm:col-span-2">
              <CardContent className="p-6 sm:p-8 text-center space-y-4">
                ...
                <h3 className="font-serif text-lg sm:text-xl font-semibold">Timeless Design</h3>
                <p className="text-muted-foreground font-light text-sm sm:text-base">
        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-10 lg:gap-16 lg:grid-cols-2 items-center">
            <div className="space-y-5 sm:space-y-6 order-2 lg:order-1">
              <h2 className="font-serif text-3xl sm:text-4xl font-bold text-balance">The Art of Craftsmanship</h2>
              <div className="space-y-4 text-muted-foreground leading-relaxed text-base sm:text-lg font-light">
                <p>
            ...
            <div className="relative h-[300px] sm:h-[400px] lg:h-[500px] rounded-3xl overflow-hidden shadow-2xl order-1 lg:order-2">
      ...
      <section className="py-16 sm:py-20 lg:py-28 bg-white">
        <div className="container mx-auto px-4">
          <Card className="border-0 bg-gradient-to-br from-primary via-raspberry to-secondary overflow-hidden shadow-2xl">
            <CardContent className="p-10 sm:p-16 lg:p-24 text-center text-white">
              <h2 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold text-balance mb-4 sm:mb-6">
                Become Part of Our Story
              </h2>
              <p className="text-base sm:text-lg md:text-xl text-white/95 max-w-2xl mx-auto mb-8 sm:mb-10 font-light">
                Discover the perfect piece to complement your special day and create memories that last forever.
              </p>
              <Button size="lg" variant="secondary" className="h-12 sm:h-14 px-8 sm:px-10 text-base shadow-xl" asChild>
